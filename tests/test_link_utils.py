...
class SocialServiceTests(unittest.TestCase):
    ...
    def test_build_fixembed_url_encodes_the_canonical_url_and_quality(self):
        ...
        self.assertEqual(
            ...
            "https://fixembed.app/embed?url=https%3A%2F%2Fx.com%2Fopenai%2Fstatus%2F123&v=151&quality=high",
        )
    ...
    def test_build_fixembed_url_preserves_twitter_translation_suffix(self):
        ...
        self.assertEqual(
            ...
            "https://fixembed.app/embed?url=https%3A%2F%2Fx.com%2Fopenai%2Fstatus%2F123&v=151&lang=es",
        )
    ...
    def test_build_fixembed_url_preserves_gallery_and_mosaic_modifiers(self):
        ...
        self.assertEqual(
            ...
            "https://fixembed.app/embed?url=https%3A%2F%2Fx.com%2Fopenai%2Fstatus%2F123&v=151&mode=gallery",
        )
        self.assertEqual(
            build_fixembed_url(mosaic),
            "https://fixembed.app/embed?url=https%3A%2F%2Fx.com%2Fopenai%2Fstatus%2F456&v=151&lang=es&mode=mosaic",
        )
    ...
    def test_automatic_twitter_provider_can_use_fxtwitter_without_changing_manual_links(self):
        ...
        self.assertEqual(
            build_fixembed_url(link, quality="high"),
            "https://fixembed.app/embed?url=https%3A%2F%2Fx.com%2Fopenai%2Fstatus%2F123&v=151&quality=high&lang=fr&mode=gallery",
        )
